  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden bg-neutral-900"
      >
        <input
          ref={fileInputRef}
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit shrink-0 text-sm text-neutral-300 bg-neutral-700"
                    >
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-[0px_10px_50px_rgba(0,0,0,0.3)] border border-neutral-700"
                )}
              >
                {isDragActive ? (
                  <motion.p
          ...
          return (
            <div
              ...
              className={`w-10 h-10 flex shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ? "bg-neutral-950"
                  : "bg-neutral-950 shadow-[0px_0px_1px_3px_rgba(0,0,0,0.5)_inset]"
              }`}
            />
          );
        })
